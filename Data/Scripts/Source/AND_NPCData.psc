...
Function TweakFemale(Actor akFemale, Int StrictRank, Int TopRank, Int BottomRank, Int MinimumStrict, Int MinimumTop, Int MinimumBottom, Int Shyness, Bool Shameless, Bool Corrupt, Bool MakeDefault, Bool Strict, Bool UpgradeBlocked) Global Native
